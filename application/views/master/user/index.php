                                    ...
                                    foreach ($alluser as $n) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                </button> <a href="<?= base_url() ?>master/user/delete/<?= $n['id_user'] ?>" class="btn btn-danger"><i class="ti ti-trash"></i></a>
                                                </button> <a href="<?= base_url() ?>master/user/detail/<?= $n['id_user'] ?>" class="btn btn-danger"><i class="ti ti-eye"></i></a>
                                            </td>
                                        </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('master/user/store') ?>" method="post">
                    <div class="mb-3">
    ...
    <div class="modal fade" id="exampleModal<?= $n['id_user'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('master/user/updatepegawai') ?>" method="post">
                        <div class="mb-3">
